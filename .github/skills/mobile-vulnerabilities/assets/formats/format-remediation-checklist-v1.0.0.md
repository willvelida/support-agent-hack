<format id="MOBILE_REMEDIATION_CHECKLIST_V1" name="Mobile Remediation Checklist" purpose="Actionable remediation plan for addressing identified mobile application vulnerabilities.">
...
WHERE:
- <VULN_ID> is String; OWASP Mobile Top 10 identifier (e.g., "MOB01:2024").
- <TIMESTAMP> is ISO8601; when the plan was generated.
- <APP_NAME> is String; target mobile application name.
