<format id="INFRA_REMEDIATION_CHECKLIST_V1" name="Infrastructure Remediation Checklist" purpose="Actionable remediation plan for addressing identified infrastructure vulnerabilities.">
...
WHERE:
- <VULN_ID> is String; OWASP Infrastructure Security identifier (e.g., "ISR01:2024").
- <TIMESTAMP> is ISO8601; when the plan was generated.
- <ENV_NAME> is String; target environment or system name.
