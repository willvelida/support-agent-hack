<format id="DOCKER_REMEDIATION_CHECKLIST_V1" name="Docker Remediation Checklist" purpose="Actionable remediation plan for addressing identified Docker container vulnerabilities.">
...
WHERE:
- <VULN_ID> is String; OWASP Docker Security identifier (e.g., "DKR01:2025").
