<format id="SERVERLESS_REMEDIATION_CHECKLIST_V1" name="Serverless Remediation Checklist" purpose="Actionable remediation plan for addressing identified serverless application vulnerabilities.">
...
WHERE:
- <VULN_ID> is String; OWASP Serverless identifier (e.g., "SLS01:2017").
- <TIMESTAMP> is ISO8601; when the plan was generated.
- <APP_NAME> is String; target serverless application name.
- <PROVIDER> is one of: AWS, AZURE, GCP, IBM, OTHER.
