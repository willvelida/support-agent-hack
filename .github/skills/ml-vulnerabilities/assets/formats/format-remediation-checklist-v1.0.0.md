<format id="ML_REMEDIATION_CHECKLIST_V1" name="ML Remediation Checklist" purpose="Actionable remediation plan for addressing identified machine learning vulnerabilities.">
...
WHERE:
- <VULN_ID> is String; OWASP ML Security identifier (e.g., "ML01:2023").
- <TIMESTAMP> is ISO8601; when the plan was generated.
- <SYSTEM_NAME> is String; target machine learning system or pipeline name.
