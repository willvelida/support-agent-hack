<format id="REMEDIATION_CHECKLIST_V1" name="Remediation Checklist" purpose="Actionable remediation plan for addressing identified MCP vulnerabilities.">
...
WHERE:
- <VULN_ID> is String; OWASP MCP identifier (e.g., "MCP01:2025").
