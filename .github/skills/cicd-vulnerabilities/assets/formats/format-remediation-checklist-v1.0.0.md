<format id="CICD_REMEDIATION_CHECKLIST_V1" name="CI/CD Remediation Checklist" purpose="Actionable remediation plan for addressing identified CI/CD pipeline vulnerabilities.">
...
WHERE:
- <VULN_ID> is String; OWASP CI/CD Security identifier (e.g., "CICD-SEC-1:2025").
